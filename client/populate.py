...
def run():
    ...
    # gmail
    print("\nDingdang uses your Gmail to send notifications. Alternatively, " +
          "you can skip this step (or just fill in the email address if you " +
          "want to receive email notifications) and setup a Mailgun " +
          "account, as at http://dingdangproject.github.io/documentation/" +
          "software/#mailgun.\n")
    ...
    outputFile = open(dingdangpath.config("profile.yml"), "w")
